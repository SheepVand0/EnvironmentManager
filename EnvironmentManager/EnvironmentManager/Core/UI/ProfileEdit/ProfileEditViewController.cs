    ...
    internal class ProfileEditViewController : ViewController<ProfileEditViewController>
    {
        ...
        protected override void OnViewCreation()
        {
            Templates.FullRectLayout(
                ...
                XUIHLayout.Make(
                    EMText.Make("Only with static lights: "),
                    EMToggleSetting.Make()
                        .SetValue(EMConfig.Instance.UserProfiles[EMConfig.Instance.SelectedIndex].OnlyInStaticLights)
                        .OnValueChanged(x =>
                        {
                            EMConfig.Instance.UserProfiles[EMConfig.Instance.SelectedIndex].OnlyInStaticLights = x;

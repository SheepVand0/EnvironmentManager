...
{
    internal class EMTextInput : XUITextInput
    {
        protected EMTextInput(string p_Name, string p_PlaceHolder) : base(p_Name, p_PlaceHolder)
        {
            OnReady(OnCreation);
        }

        public static new EMTextInput Make(string p_PlaceHolder)
        {
            return new EMTextInput("GuildSaberTextinput", p_PlaceHolder);
        }
        ...
        public EMTextInput Bind(ref EMTextInput p_Input)
        {
            p_Input = this;
            return this;
        }

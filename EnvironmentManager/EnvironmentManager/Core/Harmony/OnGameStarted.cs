...
namespace EnvironmentManager.Core.Harmony
{
    ...
    internal class OnGameStarted
    {
        ...
        public static async void Postfix()
        {
            ...
            if (EMConfig.Instance.ScoreVisualizerProfile.ScoreVisualizerEnabled)
                FlyingScorePatch.LoadedConfig = EMConfig.EMScoreVisualizerProfile.Load(EMConfig.Instance.ScoreVisualizerProfile.ConfigPath);
